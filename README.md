...
En la página 3 de la presentación corporativa se menciona transformar las tablas estáticas en historias visuales dinámicas. Se baraja la posibilidad de crear un pequeño script o servicio intermedio que exporte la estructura de los proyectos compuestos (getCoste(), nombres, horas acumuladas) a archivos estructurados como JSON o CSV. Estos archivos servirán como fuente de datos directa para alimentar herramientas de Business Intelligence (como Power BI) o un frontend interactivo, permitiendo pintar los gráficos de "Proyección de Ahorro Anual" y los flujos financieros.
